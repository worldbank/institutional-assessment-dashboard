...
packages <- c("tidyverse","here","knitr","sf","ggtext","showtext","ggflags","ggbeeswarm","countrycode")
...
```{r countries_region, fig.cap="Group countries overview static CTF", fig.height = 6.5, fig.width = 9, warning=F}
...
ggplot() +
  ...
  geom_text(
    ...
    aes(x = x + 0.1, y = y),
    hjust = "left",
    label = "Countries with the best performance",
    size = 3,
    family = "Roboto Condensed",
    color = id_colors$primary
  ) +
  ...
  theme(
    ...
    axis.ticks = element_blank(),
    axis.title.x = element_text(size = 12, face = "bold", margin = margin(t = 15, r = 0, b = 5, l = 0)),
    axis.text.y = element_text(size = 10, color = id_colors$primary),
    axis.text.x = element_text(size = 8, color = id_colors$primary),
    legend.box = "vertical"
  )
