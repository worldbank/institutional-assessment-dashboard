...
ggplot() +
  ...
  theme(
    ...
    legend.title = element_text(size=11, margin = margin(t = 0, r = 0, b = 0, l = 0)),
    legend.background = element_rect(fill = NA),
    ...
    axis.ticks = element_blank(),
    axis.title.x = element_text(size = 14, face = "bold", margin = margin(t = 10, r = 0, b = 5, l = 0)),
    axis.text.y = element_text(size = 14, color = id_colors$primary),
    axis.text.x = element_text(size = 11, color = id_colors$primary, margin = margin(t = 20, r = 0, b = 5, l = 0)),
    legend.box = "vertical"
  )
...
```{r climate_violin, fig.cap="Climate Change and Environment Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
ggplot(
  ...
  theme(
    ...
    legend.title = element_text(size = 18, hjust = 0.5, margin = margin(t = 0, r = 0, b = 5, l = 0)),
    legend.background = element_rect(fill = NA),
    legend.box = "vertical",
    legend.title.position = "top",
    strip.background = element_rect(fill = NA),
    strip.text = element_text(size = 16, color = id_colors$primary, face = "bold"),
    axis.ticks = element_blank(),
...
```{r service_violin, fig.cap="Service Delivery Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r labor_violin, fig.cap="Labor and Social Protection Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r soe_violin, fig.cap="SOE Corporate Governance static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r busi_violin, fig.cap="Business Environment static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r digi_violin, fig.cap="Digital and Data Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r human_violin, fig.cap="Public Human Resource Management Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r finance_violin, fig.cap="Public Finance Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r just_violin, fig.cap="Justice Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r transp_violin, fig.cap="Transparency and Accountability Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r corruption_violin, fig.cap="Absence of Corruption static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r social_violin, fig.cap="Social Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
...
```{r poli_violin, fig.cap="Political Institutions static CTF", fig.height=10, fig.width=16, fig.dpi=600, warning=F}
