...
```{r transp_violin, fig.cap="Transparency and Accountability Institutions static CTF", fig.height=14, fig.width=16, fig.dpi=600, warning=F}
...
```{r corruption_violin, fig.cap="Absence of Corruption static CTF", fig.height=14, fig.width=16, fig.dpi=600, warning=F}
...
```{r social_violin, fig.cap="Social Institutions static CTF", fig.height=14, fig.width=16, fig.dpi=600, warning=F}
...
```{r poli_violin, fig.cap="Political Institutions static CTF", fig.height=14, fig.width=16, fig.dpi=600, warning=F}
