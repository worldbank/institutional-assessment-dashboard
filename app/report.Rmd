...
#knitr::include_graphics(params$fig1)
```
...
```{r, fig.cap="Traffic light coloring, as used in the institutional benchmarking exercise"}
#knitr::include_graphics(params$fig2
```
