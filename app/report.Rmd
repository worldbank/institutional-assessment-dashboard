...
families <-
  ...
  if (length(families) > 0) {
    ...
    cat("\n\n",
      ...
      counts_category$count[counts_category$status=="Weak\n(bottom 25%)"],
      "indicators demonstrate a weak performance",
      counts_category$count[counts_category$status=="Emerging\n(25% - 50%)"],
      " indicators exhibit emerging performance, and",
      counts_category$count[counts_category$status=="Strong\n(top 50%)"],
