...
map(all_years, function(x){
  ...
  ggsave(paste0("figs/overview", plot_year, ".png"), bg = "white",  width = 12, height = 8, scale = 0.7)
  ggsave(paste0("figs/overview", plot_year, ".svg"), bg = "white",  width = 12, height = 8, scale = 0.7)
})
...
map(all_years, function(x){
  ...
  map(1:length(fam_vars), ~ {
    ...
    name_png <- paste0("figs/", name, plot_year, ".png")
    name_svg <- paste0("figs/", name, plot_year, ".svg")
    
    ## Make plot
    make_fam_plot(.x)
    ggsave(filename = name_png, bg = "white", device = png, width = 12, height = 8, scale = 0.7)
    ggsave(filename = name_svg, bg = "white", device = svg, width = 12, height = 8, scale = 0.7)
  })
