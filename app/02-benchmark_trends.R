...
ggsave("figs/benchmark_trends_overview.png", bg = "white", width = 12, height = 8, scale = 0.7)
ggsave("figs/benchmark_trends_overview.svg", bg = "white", width = 12, height = 8, scale = 0.7)
...
map(1:length(fam_vars), ~ {
  ...
  name_png <- paste0("figs/benchmark_trends_", name, ".png")
  name_svg <- paste0("figs/benchmark_trends_", name, ".svg")
  
  make_fam_plot(.x)
  ggsave(filename = name_png, bg = "white", width = 12, height = 8, scale = 0.7)
  ggsave(filename = name_svg, bg = "white", width = 12, height = 8, scale = 0.7)
