# Cleaning files from the 2023-2024 data bash

-   Input: `data/input/**`
-   Output: `data/output/2024/clean-2024version-*.csv.gz`
 

This script uses the 'RStata' package for initial cleaning of manually imported data,
