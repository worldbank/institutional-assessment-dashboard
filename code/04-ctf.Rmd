...
For the static benchmark, we only calculate averages for indicators starting in the year 2013.
...
Note: This step in our pipeline raises a warning that we have a many-to-many relationship. This is expected, since we have multiple country-codes on both datasets (indicators and groups).
