...
```{r wdi rename db_variables convention, eval=FALSE, include=FALSE}
...
db_variables_names <- db_variables %>% 
  filter(variable %in% c("wdi_seadtlitrfezs", "wdi_seadtlitrmazs", "wdi_seadtlitrzs", 
                          "wdi_shdynmort", "wdi_shstaanvczs", "wdi_shstammrt", 
                          "wdi_spdynamrtfe", "wdi_spdynamrtma"))
...
# [1] "Extra columns in wdix:" db-variables
# > print(extra_wdix_cols)
...
###
  ...
  # "SH.STA.PRSC.ZS",     # Pregnant women receiving prenatal care
  # "SH.MMR.RATIO",       # Maternal mortality ratio
  # "SH.DYN.MORT.FE",     # Mortality rate, adult female
...
cliar_indicators_diagnostic |> 
    write_rds(
      here(
        "data",
        "output",
        "diagnostics_compiled_indicators_24.rds"
      )
    )
```
