  ...
  mutate(
    ...
    var_name =
      case_when(
        ...
        variable == "hiring_pract" ~ "Hiring and firing practices",
        variable == "steering_capability" ~ "Steering Capability",
        variable == "undue_influ_corrupt" ~ "Undue influence and corruption",
        ...
        variable == "v2clrspct" ~ "Impartial Public Administration",
        ...
        variable == "val_direct_contracts_sh" ~ "Share of direct contracts",
