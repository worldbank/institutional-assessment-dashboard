...
Some variable are measured in opposite scale, where a lower value means a better performance. To apply the closeness to frontier methodology, we need all indicators to point to the same direction, where higher values mean better perfomances.
