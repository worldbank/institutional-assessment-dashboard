...
1. Copy the data files in the OneDrive to the `etl/data/input` folder in GitHub.
1. Open the R Project `etl.Rproj`,use the index.Rmd file and bookdown::render_book() command to generate the data.
